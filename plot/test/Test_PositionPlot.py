...
class TestInit(unittest.TestCase):
    ...
    def test_init_wrong_interval_bounds(self):
        ...
        args['interval_min'] = 1
        args['interval_max'] = 0        
        self.assertRaises(PositionPlot.IntervalBoundsError,
...
class TestDefineTicks(unittest.TestCase):
    ...
    def setUp(self):
        self.plot = PositionPlot.PositionPlot()
    
    def test_define_ticks_different_lengths(self):
        names = ['a', 'b']
        pos = [0.0]
        self.assertRaises(PositionPlot.LengthError,
...
class TestInterval(unittest.TestCase):
    ...
    def setUp(self):
        self.plot = PositionPlot.PositionPlot(interval_min=0.0,
                                              interval_max=1.0)
