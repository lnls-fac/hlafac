...
class TestConversion(unittest.TestCase):
    ...
    def test_normalize_out_of_range_negative(self):
        self.assertRaises(ColorConversion.RgbRangeException,
                          ColorConversion.normalize_color,
                          (0, 0, -1, 0))
    ...
    def test_denormalize_out_of_range_negative(self):
        self.assertRaises(ColorConversion.RgbRangeException,
                          ColorConversion.denormalize_color,
                          (0.0, 0.0, -0.1, 0.0))
...
class TestReturnType(unittest.TestCase):
    ...
    def test_normalize_color_tuple(self):
        t_in = (0, 50, 100, 150)
        t_out = ColorConversion.normalize_color(t_in)
    ...
    def test_denormalize_color_tuple(self):
        ...
        t_out = ColorConversion.denormalize_color(t_in)
        self.assertTrue(isinstance(t_out, tuple),
                        'tuple not returned')
