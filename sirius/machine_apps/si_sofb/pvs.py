...
pvdb = {
    ...
    'SI-GLOB:AP-SOFB.AvgMeasOrbX': {'type': 'float', 'count': _api_status.nBPM},
    'SI-GLOB:AP-SOFB.AvgMeasOrbY': {'type': 'float', 'count': _api_status.nBPM},
    ...
    'SI-GLOB:AP-SOFB.RespMat': {'type': 'float', 'count': (_api_status.nBPM*2)*(_api_status.nCH+_api_status.nCV+1)},
    'SI-GLOB:AP-SOFB.RefOrbXSlot': {'type': 'enum', 'enums': ['null', 'slot1', 'slot2']},
    'SI-GLOB:AP-SOFB.RefOrbYSlot': {'type': 'enum', 'enums': ['null', 'slot1', 'slot2']},
    'SI-GLOB:AP-SOFB.RefOrbX': {'type': 'float', 'count': _api_status.nBPM},
    'SI-GLOB:AP-SOFB.RefOrbY': {'type': 'float', 'count': _api_status.nBPM},
    'SI-GLOB:AP-SOFB.EnblListBPM': {'type': 'int', 'count': _api_status.nBPM},
    'SI-GLOB:AP-SOFB.EnblListCH': {'type': 'int', 'count': _api_status.nCH},
    'SI-GLOB:AP-SOFB.EnblListCV': {'type': 'int', 'count': _api_status.nCV},
